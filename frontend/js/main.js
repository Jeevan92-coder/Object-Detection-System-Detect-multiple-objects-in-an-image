...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try { const i=await API.getInfo(); document.getElementById("cChip").textContent=i.total_classes; if(document.getElementById("cChip2")) document.getElementById("cChip2").textContent=i.total_classes; } catch{}
  ...
  function render(d) {
    ...
    tbody.innerHTML = d.detections.length
      ...
      : `<tr><td colspan="5" style="text-align:center;color:var(--txt3);padding:20px">No objects at threshold ${d.conf_threshold}</td></tr>`;
    // Chart
